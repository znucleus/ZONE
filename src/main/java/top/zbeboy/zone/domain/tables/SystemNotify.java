...
public class SystemNotify extends TableImpl<SystemNotifyRecord> {
    ...
    private static final long serialVersionUID = 93553418;
     ...
     */
    public final TableField<SystemNotifyRecord, String> NOTIFY_TYPE = createField("notify_type", org.jooq.impl.SQLDataType.VARCHAR(10).nullable(false).defaultValue(org.jooq.impl.DSL.inline("0", org.jooq.impl.SQLDataType.VARCHAR)), this, "");
