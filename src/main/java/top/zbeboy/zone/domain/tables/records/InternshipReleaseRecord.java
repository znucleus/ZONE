...
public class InternshipReleaseRecord extends UpdatableRecordImpl<InternshipReleaseRecord> implements Record12<String, String, Timestamp, String, Timestamp, Timestamp, Timestamp, Timestamp, Byte, Integer, String, Integer> {

    private static final long serialVersionUID = 1598247495;
    ...
    @Override
    public Row12<String, String, Timestamp, String, Timestamp, Timestamp, Timestamp, Timestamp, Byte, Integer, String, Integer> valuesRow() {
    ...
    @Override
    public InternshipReleaseRecord values(String value1, String value2, Timestamp value3, String value4, Timestamp value5, Timestamp value6, Timestamp value7, Timestamp value8, Byte value9, Integer value10, String value11, Integer value12) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
