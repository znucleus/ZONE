...
public class OauthClientUsersRecord extends UpdatableRecordImpl<OauthClientUsersRecord> implements Record5<String, String, String, String, Timestamp> {

    private static final long serialVersionUID = 523869864;
    ...
    @Override
    public OauthClientUsersRecord value5(Timestamp value) {
        setCreateDate(value);
        return this;
    }

    @Override
    public OauthClientUsersRecord values(String value1, String value2, String value3, String value4, Timestamp value5) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public OauthClientUsersRecord(String clientId, String username, String appName, String remark, Timestamp createDate) {
        super(OauthClientUsers.OAUTH_CLIENT_USERS);
