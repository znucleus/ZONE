...
public class SystemMailboxLog extends TableImpl<SystemMailboxLogRecord> {
    ...
    private static final long serialVersionUID = -1724827092;

    /**
     * The reference instance of <code>zone.system_mailbox_log</code>
     */
    ...
    /**
     * The column <code>zone.system_mailbox_log.log_id</code>.
     */
    public final TableField<SystemMailboxLogRecord, String> LOG_ID = createField(DSL.name("log_id"), org.jooq.impl.SQLDataType.VARCHAR(64).nullable(false), this, "");

    /**
     * The column <code>zone.system_mailbox_log.send_time</code>.
     */
    public final TableField<SystemMailboxLogRecord, Timestamp> SEND_TIME = createField(DSL.name("send_time"), org.jooq.impl.SQLDataType.TIMESTAMP, this, "");

    /**
     * The column <code>zone.system_mailbox_log.accept_mail</code>.
     */
    public final TableField<SystemMailboxLogRecord, String> ACCEPT_MAIL = createField(DSL.name("accept_mail"), org.jooq.impl.SQLDataType.VARCHAR(200), this, "");

    /**
     * The column <code>zone.system_mailbox_log.send_condition</code>.
     */
    public final TableField<SystemMailboxLogRecord, String> SEND_CONDITION = createField(DSL.name("send_condition"), org.jooq.impl.SQLDataType.VARCHAR(500), this, "");

    /**
     * Create a <code>zone.system_mailbox_log</code> table reference
     */
    ...
    /**
     * Create an aliased <code>zone.system_mailbox_log</code> table reference
     */
