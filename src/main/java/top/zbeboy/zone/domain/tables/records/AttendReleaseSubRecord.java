...
public class AttendReleaseSubRecord extends UpdatableRecordImpl<AttendReleaseSubRecord> implements Record11<String, String, Timestamp, Timestamp, Byte, Timestamp, Timestamp, Integer, String, String, Timestamp> {

    private static final long serialVersionUID = 1983035892;
    ...
    @Override
    public Row11<String, String, Timestamp, Timestamp, Byte, Timestamp, Timestamp, Integer, String, String, Timestamp> valuesRow() {
    ...
    @Override
    public AttendReleaseSubRecord value1(String value) {
    ...
    @Override
    public AttendReleaseSubRecord values(String value1, String value2, Timestamp value3, Timestamp value4, Byte value5, Timestamp value6, Timestamp value7, Integer value8, String value9, String value10, Timestamp value11) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public AttendReleaseSubRecord(String attendReleaseSubId, String title, Timestamp attendStartTime, Timestamp attendEndTime, Byte isAuto, Timestamp validDate, Timestamp expireDate, Integer organizeId, String username, String attendReleaseId, Timestamp releaseTime) {
        super(AttendReleaseSub.ATTEND_RELEASE_SUB);
