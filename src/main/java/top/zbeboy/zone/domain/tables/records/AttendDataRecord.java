...
public class AttendDataRecord extends UpdatableRecordImpl<AttendDataRecord> implements Record7<String, Integer, String, String, Byte, Timestamp, String> {

    private static final long serialVersionUID = -315201193;
    ...
    /**
     * Setter for <code>zone.attend_data.device_same</code>.
     */
    public void setDeviceSame(Byte value) {
        set(4, value);
    }

    /**
     * Getter for <code>zone.attend_data.device_same</code>.
     */
    ...
    @Override
    public Row7<String, Integer, String, String, Byte, Timestamp, String> valuesRow() {
    ...
    public Field<Byte> field5() {
        return AttendData.ATTEND_DATA.DEVICE_SAME;
    }
    ...
    @Override
    public AttendDataRecord value5(Byte value) {
        setDeviceSame(value);
        return this;
    }

    @Override
    public AttendDataRecord value6(Timestamp value) {
        setAttendDate(value);
        return this;
    }

    @Override
    public AttendDataRecord value7(String value) {
        setAttendRemark(value);
        return this;
    }

    @Override
    public AttendDataRecord values(String value1, Integer value2, String value3, String value4, Byte value5, Timestamp value6, String value7) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public AttendDataRecord(String attendUsersId, Integer attendReleaseSubId, String location, String address, Byte deviceSame, Timestamp attendDate, String attendRemark) {
        super(AttendData.ATTEND_DATA);
