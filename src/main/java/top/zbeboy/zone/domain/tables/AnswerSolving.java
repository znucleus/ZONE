...
public class AnswerSolving extends TableImpl<AnswerSolvingRecord> {
    ...
    private static final long serialVersionUID = 1217288750;
     ...
     */
    public final TableField<AnswerSolvingRecord, String> ANSWER_SOLVING_ID = createField("answer_solving_id", org.jooq.impl.SQLDataType.VARCHAR(64).nullable(false), this, "");

    /**
     * The column <code>zone.answer_solving.answer_subject_id</code>.
     */
    public final TableField<AnswerSolvingRecord, String> ANSWER_SUBJECT_ID = createField("answer_subject_id", org.jooq.impl.SQLDataType.VARCHAR(64).nullable(false), this, "");

    /**
     * The column <code>zone.answer_solving.select_key</code>.
     */
    public final TableField<AnswerSolvingRecord, String> SELECT_KEY = createField("select_key", org.jooq.impl.SQLDataType.VARCHAR(10), this, "");

    /**
     * The column <code>zone.answer_solving.right_key</code>.
     */
    public final TableField<AnswerSolvingRecord, String> RIGHT_KEY = createField("right_key", org.jooq.impl.SQLDataType.VARCHAR(10).nullable(false), this, "");

    /**
     * The column <code>zone.answer_solving.user_id</code>.
     */
    public final TableField<AnswerSolvingRecord, String> USER_ID = createField("user_id", org.jooq.impl.SQLDataType.VARCHAR(64).nullable(false), this, "");

    /**
     * The column <code>zone.answer_solving.user_name</code>.
     */
    public final TableField<AnswerSolvingRecord, String> USER_NAME = createField("user_name", org.jooq.impl.SQLDataType.VARCHAR(20), this, "");

    /**
     * The column <code>zone.answer_solving.answer_release_id</code>.
     */
    public final TableField<AnswerSolvingRecord, String> ANSWER_RELEASE_ID = createField("answer_release_id", org.jooq.impl.SQLDataType.VARCHAR(64).nullable(false), this, "");
