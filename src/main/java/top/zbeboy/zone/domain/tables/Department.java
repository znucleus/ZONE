...
public class Department extends TableImpl<DepartmentRecord> {
    ...
    private static final long serialVersionUID = 996782645;
     ...
     */
    public final TableField<DepartmentRecord, Integer> DEPARTMENT_ID = createField(DSL.name("department_id"), org.jooq.impl.SQLDataType.INTEGER.nullable(false).identity(true), this, "");

    /**
     * The column <code>zone.department.department_name</code>.
     */
    public final TableField<DepartmentRecord, String> DEPARTMENT_NAME = createField(DSL.name("department_name"), org.jooq.impl.SQLDataType.VARCHAR(200).nullable(false), this, "");

    /**
     * The column <code>zone.department.department_is_del</code>.
     */
    public final TableField<DepartmentRecord, Byte> DEPARTMENT_IS_DEL = createField(DSL.name("department_is_del"), org.jooq.impl.SQLDataType.TINYINT, this, "");

    /**
     * The column <code>zone.department.college_id</code>.
     */
    public final TableField<DepartmentRecord, Integer> COLLEGE_ID = createField(DSL.name("college_id"), org.jooq.impl.SQLDataType.INTEGER.nullable(false), this, "");
