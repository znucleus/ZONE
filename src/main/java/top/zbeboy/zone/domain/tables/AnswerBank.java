...
public class AnswerBank extends TableImpl<AnswerBankRecord> {
    ...
    private static final long serialVersionUID = -1420578467;
     ...
     */
    public final TableField<AnswerBankRecord, String> ANSWER_BANK_ID = createField("answer_bank_id", org.jooq.impl.SQLDataType.VARCHAR(64).nullable(false), this, "");

    /**
     * The column <code>zone.answer_bank.bank_name</code>.
     */
    public final TableField<AnswerBankRecord, String> BANK_NAME = createField("bank_name", org.jooq.impl.SQLDataType.VARCHAR(100).nullable(false), this, "");

    /**
     * The column <code>zone.answer_bank.username</code>.
     */
    public final TableField<AnswerBankRecord, String> USERNAME = createField("username", org.jooq.impl.SQLDataType.VARCHAR(64).nullable(false), this, "");

    /**
     * The column <code>zone.answer_bank.create_date</code>.
     */
    public final TableField<AnswerBankRecord, Timestamp> CREATE_DATE = createField("create_date", org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false), this, "");
