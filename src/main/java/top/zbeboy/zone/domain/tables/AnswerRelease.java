...
public class AnswerRelease extends TableImpl<AnswerReleaseRecord> {
    ...
    private static final long serialVersionUID = 172390051;
     ...
     */
    public final TableField<AnswerReleaseRecord, String> ANSWER_RELEASE_ID = createField("answer_release_id", org.jooq.impl.SQLDataType.VARCHAR(64).nullable(false), this, "");

    /**
     * The column <code>zone.answer_release.title</code>.
     */
    public final TableField<AnswerReleaseRecord, String> TITLE = createField("title", org.jooq.impl.SQLDataType.VARCHAR(100).nullable(false), this, "");

    /**
     * The column <code>zone.answer_release.start_time</code>.
     */
    public final TableField<AnswerReleaseRecord, Timestamp> START_TIME = createField("start_time", org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false), this, "");

    /**
     * The column <code>zone.answer_release.end_time</code>.
     */
    public final TableField<AnswerReleaseRecord, Timestamp> END_TIME = createField("end_time", org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false), this, "");

    /**
     * The column <code>zone.answer_release.answer_bank_id</code>.
     */
    public final TableField<AnswerReleaseRecord, String> ANSWER_BANK_ID = createField("answer_bank_id", org.jooq.impl.SQLDataType.VARCHAR(64).nullable(false), this, "");

    /**
     * The column <code>zone.answer_release.username</code>.
     */
    public final TableField<AnswerReleaseRecord, String> USERNAME = createField("username", org.jooq.impl.SQLDataType.VARCHAR(64).nullable(false), this, "");

    /**
     * The column <code>zone.answer_release.release_time</code>.
     */
    public final TableField<AnswerReleaseRecord, Timestamp> RELEASE_TIME = createField("release_time", org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false), this, "");
