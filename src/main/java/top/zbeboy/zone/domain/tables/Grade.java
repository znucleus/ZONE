...
public class Grade extends TableImpl<GradeRecord> {
    ...
    private static final long serialVersionUID = -1766232399;
     ...
     */
    public final TableField<GradeRecord, Integer> GRADE_ID = createField(DSL.name("grade_id"), org.jooq.impl.SQLDataType.INTEGER.nullable(false).identity(true), this, "");

    /**
     * The column <code>zone.grade.grade</code>.
     */
    public final TableField<GradeRecord, Integer> GRADE_ = createField(DSL.name("grade"), org.jooq.impl.SQLDataType.INTEGER.nullable(false), this, "");

    /**
     * The column <code>zone.grade.grade_is_del</code>.
     */
    public final TableField<GradeRecord, Byte> GRADE_IS_DEL = createField(DSL.name("grade_is_del"), org.jooq.impl.SQLDataType.TINYINT, this, "");

    /**
     * The column <code>zone.grade.science_id</code>.
     */
    public final TableField<GradeRecord, Integer> SCIENCE_ID = createField(DSL.name("science_id"), org.jooq.impl.SQLDataType.INTEGER.nullable(false), this, "");
