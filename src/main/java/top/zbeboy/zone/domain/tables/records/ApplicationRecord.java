...
public class ApplicationRecord extends UpdatableRecordImpl<ApplicationRecord> implements Record9<String, String, Integer, String, String, String, String, String, String> {
    ...
    private static final long serialVersionUID = 286955207;

    /**
     * Setter for <code>zhe.application.application_id</code>.
     */
    ...
    /**
     * Getter for <code>zhe.application.application_id</code>.
     */
    @NotNull
    @Size(max = 64)
    ...
    /**
     * Setter for <code>zhe.application.application_name</code>.
     */
    ...
    /**
     * Getter for <code>zhe.application.application_name</code>.
     */
    @NotNull
    @Size(max = 30)
    ...
    /**
     * Setter for <code>zhe.application.application_sort</code>.
     */
    ...
    /**
     * Getter for <code>zhe.application.application_sort</code>.
     */
    ...
    /**
     * Setter for <code>zhe.application.application_pid</code>.
     */
    ...
    /**
     * Getter for <code>zhe.application.application_pid</code>.
     */
    @NotNull
    @Size(max = 64)
    ...
    /**
     * Setter for <code>zhe.application.application_url</code>.
     */
    ...
    /**
     * Getter for <code>zhe.application.application_url</code>.
     */
    @NotNull
    @Size(max = 300)
    ...
    /**
     * Setter for <code>zhe.application.application_code</code>.
     */
    ...
    /**
     * Getter for <code>zhe.application.application_code</code>.
     */
    @NotNull
    @Size(max = 100)
    ...
    /**
     * Setter for <code>zhe.application.application_en_name</code>.
     */
    ...
    /**
     * Getter for <code>zhe.application.application_en_name</code>.
     */
    @NotNull
    @Size(max = 100)
    ...
    /**
     * Setter for <code>zhe.application.icon</code>.
     */
    ...
    /**
     * Getter for <code>zhe.application.icon</code>.
     */
    @Size(max = 100)
    ...
    /**
     * Setter for <code>zhe.application.application_data_url_start_with</code>.
     */
    ...
    /**
     * Getter for <code>zhe.application.application_data_url_start_with</code>.
     */
    @Size(max = 300)
