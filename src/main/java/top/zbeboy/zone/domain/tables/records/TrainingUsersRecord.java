...
public class TrainingUsersRecord extends UpdatableRecordImpl<TrainingUsersRecord> implements Record3<String, String, Integer> {
    ...
    private static final long serialVersionUID = 1668999283;

    /**
     * Setter for <code>zhe.training_users.training_users_id</code>.
     */
    ...
    /**
     * Getter for <code>zhe.training_users.training_users_id</code>.
     */
    @NotNull
    @Size(max = 64)
    ...
    /**
     * Setter for <code>zhe.training_users.training_release_id</code>.
     */
    ...
    /**
     * Getter for <code>zhe.training_users.training_release_id</code>.
     */
    @NotNull
    @Size(max = 64)
    ...
    /**
     * Setter for <code>zhe.training_users.student_id</code>.
     */
    ...
    /**
     * Getter for <code>zhe.training_users.student_id</code>.
     */
    @NotNull
