...
public class CollegeRole extends TableImpl<CollegeRoleRecord> {
    ...
    private static final long serialVersionUID = 28738973;

    /**
     * The reference instance of <code>zhe.college_role</code>
     */
    ...
    /**
     * The column <code>zhe.college_role.role_id</code>.
     */
    public final TableField<CollegeRoleRecord, String> ROLE_ID = createField("role_id", org.jooq.impl.SQLDataType.VARCHAR(64).nullable(false), this, "");

    /**
     * The column <code>zhe.college_role.college_id</code>.
     */
    ...
    /**
     * The column <code>zhe.college_role.allow_agent</code>.
     */
    public final TableField<CollegeRoleRecord, Byte> ALLOW_AGENT = createField("allow_agent", org.jooq.impl.SQLDataType.TINYINT.defaultValue(DSL.inline("0", org.jooq.impl.SQLDataType.TINYINT)), this, "");

    /**
     * Create a <code>zhe.college_role</code> table reference
     */
    public CollegeRole() {
    ...
    /**
     * Create an aliased <code>zhe.college_role</code> table reference
     */
