...
public class UserNotify extends TableImpl<UserNotifyRecord> {
    ...
    private static final long serialVersionUID = 339063137;

    /**
     * The reference instance of <code>zhe.user_notify</code>
     */
    ...
    /**
     * The column <code>zhe.user_notify.user_notify_id</code>.
     */
    ...
    /**
     * The column <code>zhe.user_notify.notify_title</code>.
     */
    ...
    /**
     * The column <code>zhe.user_notify.notify_content</code>.
     */
    ...
    /**
     * The column <code>zhe.user_notify.create_date</code>.
     */
    ...
    /**
     * The column <code>zhe.user_notify.notify_type</code>.
     */
    public final TableField<UserNotifyRecord, String> NOTIFY_TYPE = createField("notify_type", org.jooq.impl.SQLDataType.VARCHAR(10).nullable(false).defaultValue(DSL.inline("0", org.jooq.impl.SQLDataType.VARCHAR)), this, "");

    /**
     * The column <code>zhe.user_notify.is_see</code>.
     */
    public final TableField<UserNotifyRecord, Byte> IS_SEE = createField("is_see", org.jooq.impl.SQLDataType.TINYINT.defaultValue(DSL.inline("0", org.jooq.impl.SQLDataType.TINYINT)), this, "");

    /**
     * The column <code>zhe.user_notify.send_user</code>.
     */
    ...
    /**
     * The column <code>zhe.user_notify.accept_user</code>.
     */
    ...
    /**
     * Create a <code>zhe.user_notify</code> table reference
     */
    public UserNotify() {
    ...
    /**
     * Create an aliased <code>zhe.user_notify</code> table reference
     */
