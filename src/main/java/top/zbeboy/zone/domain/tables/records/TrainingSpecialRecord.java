...
public class TrainingSpecialRecord extends UpdatableRecordImpl<TrainingSpecialRecord> implements Record5<String, String, String, String, Timestamp> {

    private static final long serialVersionUID = -1434371654;
    ...
    @Override
    public TrainingSpecialRecord value5(Timestamp value) {
        setReleaseTime(value);
        return this;
    }

    @Override
    public TrainingSpecialRecord values(String value1, String value2, String value3, String value4, Timestamp value5) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public TrainingSpecialRecord(String trainingSpecialId, String title, String username, String publisher, Timestamp releaseTime) {
        super(TrainingSpecial.TRAINING_SPECIAL);
