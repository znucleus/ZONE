...
public class InternshipTeacherDistributionRecord extends UpdatableRecordImpl<InternshipTeacherDistributionRecord> implements Record6<Integer, Integer, String, String, String, String> {
    ...
    private static final long serialVersionUID = -376495009;

    /**
     * Setter for <code>zone.internship_teacher_distribution.staff_id</code>.
     */
    ...
    /**
     * Getter for <code>zone.internship_teacher_distribution.staff_id</code>.
     */
    @NotNull
    ...
    /**
     * Setter for <code>zone.internship_teacher_distribution.student_id</code>.
     */
    ...
    /**
     * Getter for <code>zone.internship_teacher_distribution.student_id</code>.
     */
    @NotNull
    ...
    /**
     * Setter for <code>zone.internship_teacher_distribution.internship_release_id</code>.
     */
    ...
    /**
     * Getter for <code>zone.internship_teacher_distribution.internship_release_id</code>.
     */
    @NotNull
    @Size(max = 64)
    ...
    /**
     * Setter for <code>zone.internship_teacher_distribution.username</code>.
     */
    ...
    /**
     * Getter for <code>zone.internship_teacher_distribution.username</code>.
     */
    @NotNull
    @Size(max = 200)
    ...
    /**
     * Setter for <code>zone.internship_teacher_distribution.student_real_name</code>.
     */
    ...
    /**
     * Getter for <code>zone.internship_teacher_distribution.student_real_name</code>.
     */
    @NotNull
    @Size(max = 30)
    ...
    /**
     * Setter for <code>zone.internship_teacher_distribution.assigner</code>.
     */
    ...
    /**
     * Getter for <code>zone.internship_teacher_distribution.assigner</code>.
     */
    @NotNull
    @Size(max = 30)
