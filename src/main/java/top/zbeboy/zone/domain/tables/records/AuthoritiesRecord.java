...
public class AuthoritiesRecord extends UpdatableRecordImpl<AuthoritiesRecord> implements Record2<String, String> {
    ...
    private static final long serialVersionUID = -1459532923;

    /**
     * Setter for <code>zhe.authorities.username</code>.
     */
    ...
    /**
     * Getter for <code>zhe.authorities.username</code>.
     */
    @NotNull
    @Size(max = 64)
    ...
    /**
     * Setter for <code>zhe.authorities.authority</code>.
     */
    ...
    /**
     * Getter for <code>zhe.authorities.authority</code>.
     */
    @NotNull
    @Size(max = 50)
