...
public class TrainingDocumentFile extends TableImpl<TrainingDocumentFileRecord> {
    ...
    private static final long serialVersionUID = -1641882961;
    ...
    /**
     * The column <code>zone.training_document_file.training_document_file_id</code>.
     */
    public final TableField<TrainingDocumentFileRecord, String> TRAINING_DOCUMENT_FILE_ID = createField(DSL.name("training_document_file_id"), org.jooq.impl.SQLDataType.VARCHAR(64).nullable(false), this, "");

    /**
     * The column <code>zone.training_document_file.training_release_id</code>.
     */
    public final TableField<TrainingDocumentFileRecord, String> TRAINING_RELEASE_ID = createField(DSL.name("training_release_id"), org.jooq.impl.SQLDataType.VARCHAR(64).nullable(false), this, "");
    ...
    public List<Index> getIndexes() {
        return Arrays.<Index>asList(Indexes.TRAINING_DOCUMENT_FILE_COURSE_ID, Indexes.TRAINING_DOCUMENT_FILE_FILE_ID, Indexes.TRAINING_DOCUMENT_FILE_PRIMARY, Indexes.TRAINING_DOCUMENT_FILE_TRAINING_RELEASE_ID, Indexes.TRAINING_DOCUMENT_FILE_USERNAME);
    }

    @Override
    public UniqueKey<TrainingDocumentFileRecord> getPrimaryKey() {
        return Keys.KEY_TRAINING_DOCUMENT_FILE_PRIMARY;
    }

    @Override
    public List<UniqueKey<TrainingDocumentFileRecord>> getKeys() {
        return Arrays.<UniqueKey<TrainingDocumentFileRecord>>asList(Keys.KEY_TRAINING_DOCUMENT_FILE_PRIMARY);
    }
    ...
    public TrainingRelease trainingRelease() {
        return new TrainingRelease(this, Keys.TRAINING_DOCUMENT_FILE_IBFK_1);
    }
