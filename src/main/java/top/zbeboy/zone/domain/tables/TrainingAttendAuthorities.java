...
public class TrainingAttendAuthorities extends TableImpl<TrainingAttendAuthoritiesRecord> {
    ...
    private static final long serialVersionUID = -1330699437;

    /**
     * The reference instance of <code>zhe.training_attend_authorities</code>
     */
    ...
    /**
     * The column <code>zhe.training_attend_authorities.authorities_id</code>.
     */
    public final TableField<TrainingAttendAuthoritiesRecord, String> AUTHORITIES_ID = createField("authorities_id", org.jooq.impl.SQLDataType.VARCHAR(64).nullable(false), this, "");

    /**
     * The column <code>zhe.training_attend_authorities.training_attend_id</code>.
     */
    public final TableField<TrainingAttendAuthoritiesRecord, String> TRAINING_ATTEND_ID = createField("training_attend_id", org.jooq.impl.SQLDataType.VARCHAR(64).nullable(false), this, "");

    /**
     * The column <code>zhe.training_attend_authorities.username</code>.
     */
    public final TableField<TrainingAttendAuthoritiesRecord, String> USERNAME = createField("username", org.jooq.impl.SQLDataType.VARCHAR(64).nullable(false), this, "");

    /**
     * The column <code>zhe.training_attend_authorities.operate_type</code>.
     */
    public final TableField<TrainingAttendAuthoritiesRecord, Byte> OPERATE_TYPE = createField("operate_type", org.jooq.impl.SQLDataType.TINYINT.nullable(false), this, "");

    /**
     * The column <code>zhe.training_attend_authorities.expire_date</code>.
     */
    public final TableField<TrainingAttendAuthoritiesRecord, Timestamp> EXPIRE_DATE = createField("expire_date", org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false), this, "");

    /**
     * Create a <code>zhe.training_attend_authorities</code> table reference
     */
    ...
    /**
     * Create an aliased <code>zhe.training_attend_authorities</code> table reference
     */
