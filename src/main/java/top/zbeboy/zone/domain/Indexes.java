...
public class Indexes {
    ...
    public static final Index TRAINING_DOCUMENT_FILE_PRIMARY = Indexes0.TRAINING_DOCUMENT_FILE_PRIMARY;
    public static final Index TRAINING_DOCUMENT_FILE_TRAINING_RELEASE_ID = Indexes0.TRAINING_DOCUMENT_FILE_TRAINING_RELEASE_ID;
    ...
    public static final Index TRAINING_SPECIAL_COVER = Indexes0.TRAINING_SPECIAL_COVER;
    ...
    public static final Index TRAINING_SPECIAL_DOCUMENT_PRIMARY = Indexes0.TRAINING_SPECIAL_DOCUMENT_PRIMARY;
    public static final Index TRAINING_SPECIAL_DOCUMENT_TRAINING_SPECIAL_ID = Indexes0.TRAINING_SPECIAL_DOCUMENT_TRAINING_SPECIAL_ID;
    public static final Index TRAINING_SPECIAL_DOCUMENT_CONTENT_TRAINING_SPECIAL_DOCUMENT_ID = Indexes0.TRAINING_SPECIAL_DOCUMENT_CONTENT_TRAINING_SPECIAL_DOCUMENT_ID;
    public static final Index TRAINING_SPECIAL_FILE_FILE_TYPE_ID = Indexes0.TRAINING_SPECIAL_FILE_FILE_TYPE_ID;
    public static final Index TRAINING_SPECIAL_FILE_PRIMARY = Indexes0.TRAINING_SPECIAL_FILE_PRIMARY;
    ...
    private static class Indexes0 {
        ...
        public static Index TRAINING_DOCUMENT_FILE_PRIMARY = Internal.createIndex("PRIMARY", TrainingDocumentFile.TRAINING_DOCUMENT_FILE, new OrderField[]{TrainingDocumentFile.TRAINING_DOCUMENT_FILE.TRAINING_DOCUMENT_FILE_ID}, true);
        public static Index TRAINING_DOCUMENT_FILE_TRAINING_RELEASE_ID = Internal.createIndex("training_release_id", TrainingDocumentFile.TRAINING_DOCUMENT_FILE, new OrderField[]{TrainingDocumentFile.TRAINING_DOCUMENT_FILE.TRAINING_RELEASE_ID}, false);
        ...
        public static Index TRAINING_SPECIAL_COVER = Internal.createIndex("cover", TrainingSpecial.TRAINING_SPECIAL, new OrderField[]{TrainingSpecial.TRAINING_SPECIAL.COVER}, false);
        ...
        public static Index TRAINING_SPECIAL_DOCUMENT_PRIMARY = Internal.createIndex("PRIMARY", TrainingSpecialDocument.TRAINING_SPECIAL_DOCUMENT, new OrderField[]{TrainingSpecialDocument.TRAINING_SPECIAL_DOCUMENT.TRAINING_SPECIAL_DOCUMENT_ID}, true);
        public static Index TRAINING_SPECIAL_DOCUMENT_TRAINING_SPECIAL_ID = Internal.createIndex("training_special_id", TrainingSpecialDocument.TRAINING_SPECIAL_DOCUMENT, new OrderField[]{TrainingSpecialDocument.TRAINING_SPECIAL_DOCUMENT.TRAINING_SPECIAL_ID}, false);
        public static Index TRAINING_SPECIAL_DOCUMENT_CONTENT_TRAINING_SPECIAL_DOCUMENT_ID = Internal.createIndex("training_special_document_id", TrainingSpecialDocumentContent.TRAINING_SPECIAL_DOCUMENT_CONTENT, new OrderField[]{TrainingSpecialDocumentContent.TRAINING_SPECIAL_DOCUMENT_CONTENT.TRAINING_SPECIAL_DOCUMENT_ID}, true);
        ...
        public static Index TRAINING_SPECIAL_FILE_PRIMARY = Internal.createIndex("PRIMARY", TrainingSpecialFile.TRAINING_SPECIAL_FILE, new OrderField[]{TrainingSpecialFile.TRAINING_SPECIAL_FILE.TRAINING_SPECIAL_FILE_ID}, true);
