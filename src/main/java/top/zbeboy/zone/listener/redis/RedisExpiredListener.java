package top.zbeboy.zone.listener.redis;
...
import top.zbeboy.zone.service.cache.attend.AttendWxCacheServiceImpl;
import top.zbeboy.zone.web.util.SpringBootUtil;

public class RedisExpiredListener implements MessageListener {

    private final Logger log = LoggerFactory.getLogger(RedisExpiredListener.class);
