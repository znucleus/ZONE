...
public class BuildingServiceImpl implements BuildingService, PaginationPlugin<DataTablesUtil> {
    ...
    public void sortCondition(SelectConnectByStep<Record> step, DataTablesUtil paginationUtil) {
        ...
        if (StringUtils.isNotBlank(orderColumnName)) {
            if (StringUtils.equals("buildingId", orderColumnName)) {
            ...
            if (StringUtils.equals("buildingIsDel", orderColumnName)) {
                sortField = new SortField[2];
                if (isAsc) {
