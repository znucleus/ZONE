...
public class SoftwareAchievementExcel extends ReadExcelUtil<SoftwareSummaryAchievement> {
    ...
    @Override
    public Optional<SoftwareSummaryAchievement> buildXls(HSSFRow hssfRow) {
        Optional<SoftwareSummaryAchievement> optional = Optional.empty();
        if (hssfRow.getLastCellNum() >= 16) {
            ...
            optional = Optional.of(softwareSummaryAchievement);
        }
    ...
    @Override
    public Optional<SoftwareSummaryAchievement> buildXlsx(XSSFRow xssfRow) {
        Optional<SoftwareSummaryAchievement> optional = Optional.empty();
