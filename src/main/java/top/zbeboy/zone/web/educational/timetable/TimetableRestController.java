...
public class TimetableRestController {
    ...
    private final Logger log = LoggerFactory.getLogger(TimetableRestController.class);
    ...
    @GetMapping("/web/educational/timetable/import/semesters")
    ...
    public ResponseEntity<Map<String, Object>> schoolYear(HttpServletRequest request) {
        ...
        timetableSemesters.forEach(timetableSemester -> select2Data.add(timetableSemester.getTimetableSemesterId() + "", timetableSemester.getSchoolName() +
                timetableSemester.getCollegeName() + " " + timetableSemester.getName()));
        return new ResponseEntity<>(select2Data.send(false), HttpStatus.OK);
    }
