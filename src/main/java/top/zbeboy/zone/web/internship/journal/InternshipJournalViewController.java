        ...
        if (internshipConditionCommon.journalLookCondition(id)) {
            ...
            if (Objects.nonNull(internshipJournal)) {
                ...
                if (record.isPresent()) {
                    ...
                    internshipJournalContent.setInternshipJournalDateStr(DateTimeUtil.formatLocalDate(internshipJournalContent.getInternshipJournalDate(), DateTimeUtil.YEAR_MONTH_DAY_CN_FORMAT));
                    modelMap.addAttribute("internshipJournalContent", internshipJournalContent);
