...
import top.zbeboy.zone.web.vo.data.department.DepartmentVo;
...
public class DepartmentRestController {
     ...
     * 获取院下全部有效系
     *
     * @param departmentVo 查询参数
     * @return 系数据
     */
    @GetMapping("/anyone/data/department")
    public ResponseEntity<Map<String, Object>> anyoneData(DepartmentVo departmentVo) {
        Select2Data select2Data = Select2Data.of();
        Result<DepartmentRecord> departments = departmentService.findByCollegeIdAndDepartmentIsDel(departmentVo.getCollegeId(), BooleanUtil.toByte(false));
