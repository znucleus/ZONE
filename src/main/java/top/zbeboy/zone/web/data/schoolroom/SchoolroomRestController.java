...
import top.zbeboy.zone.web.vo.data.schoolroom.SchoolroomVo;
...
public class SchoolroomRestController {
     ...
     * 获取楼下全部有效教室
     *
     * @param schoolroomVo 查询参数
     * @return 教室数据
     */
    @GetMapping("/user/data/schoolroom")
    public ResponseEntity<Map<String, Object>> anyoneData(SchoolroomVo schoolroomVo) {
        Select2Data select2Data = Select2Data.of();
        Result<SchoolroomRecord> schoolrooms = schoolroomService.findByBuildingIdAndSchoolroomIsDel(schoolroomVo.getBuildingId(), BooleanUtil.toByte(false));
