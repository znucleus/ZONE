...
public final class Workbook {
    ...
    public enum SystemConfigure {
        MAIL_SWITCH, MOBILE_SWITCH, FORBIDDEN_REGISTER, CITY_USERNAME, CITY_PASSWORD, CITY_VALIDATE_URL, CITY_LOGIN_URL, CITY_PERSON_LOGIN_URL,
        CITY_VIEW_CS_URL, CITY_VIEW_SEARCH_URL, CITY_VIEW_URL
    }
