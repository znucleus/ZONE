...
(
    ...
    teacher_distribution_start_time DATETIME,
    teacher_distribution_end_time   DATETIME,
    start_time                      DATETIME,
    end_time                        DATETIME,
    ...
    is_time_limit                   BOOLEAN      NOT NULL DEFAULT 1,
...
(
    internship_info_id           VARCHAR(64) PRIMARY KEY,
    student_id                   INT          NOT NULL,
    ...
    parent_contact_phone         VARCHAR(48)  NOT NULL,
    headmaster                   VARCHAR(10)  NOT NULL,
    headmaster_tel               VARCHAR(20)  NOT NULL,
...
CREATE TABLE internship_review_authorize
(
    internship_release_id VARCHAR(64) NOT NULL,
    username              VARCHAR(64) NOT NULL,
    FOREIGN KEY (internship_release_id) REFERENCES internship_release (internship_release_id),
    FOREIGN KEY (username) REFERENCES users (username) ON UPDATE CASCADE ON DELETE CASCADE,
    PRIMARY KEY (internship_release_id, username)
);
...
INSERT INTO internship_type (internship_type_name)
VALUES ('顶岗实习(留学院)');
INSERT INTO internship_type (internship_type_name)
VALUES ('校外自主实习(去单位)');
INSERT INTO internship_type (internship_type_name)
VALUES ('毕业实习(校内)');
INSERT INTO internship_type (internship_type_name)
VALUES ('毕业实习(学校统一组织校外实习)');
INSERT INTO internship_type (internship_type_name)
VALUES ('毕业实习(学生校外自主实习)');