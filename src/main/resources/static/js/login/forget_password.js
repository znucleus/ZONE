    ...
    function ($, domready, _, Swal, tools) {
        domready(function () {
            ...
            $(param_id.verificationMode).change(function () {
                var v = $(this).val();
                if (Number(v) === 0) {
                    $(param_id.email).parent().parent().css('display', 'block');
                    $(param_id.mobile).parent().parent().css('display', 'none');
                    $(param_id.verificationCode).parent().parent().parent().css('display', 'none');
                } else {
                    $(param_id.email).parent().parent().css('display', 'none');
                    $(param_id.mobile).parent().parent().css('display', 'block');
                    $(param_id.verificationCode).parent().parent().parent().css('display', 'block');
                }
            });
