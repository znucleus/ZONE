//# sourceURL=examination_authorize.js
require(["jquery", "lodash", "tools", "moment-with-locales", "handlebars", "sweetalert2", "nav.active", "tablesaw", "messenger", "flatpickr-zh"],
    function ($, _, tools, moment, Handlebars, Swal, navActive) {
        ...
        function getAjaxUrl() {
            return {
                data: web_path + '/web/educational/examination/authorize/paging',
                save: web_path + '/web/educational/examination/authorize/save',
                del: web_path + '/web/educational/examination/authorize/delete',
