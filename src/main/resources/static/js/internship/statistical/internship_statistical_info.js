...
require(["jquery", "nav.active", "responsive.bootstrap4", "jquery.address", "messenger"],
    function ($, navActive) {
       ...
       */
        ...
        function getAjaxUrl() {
            return {
                data: web_path + '/web/internship/statistical/info/paging',
        ...
        var myTable = tableElement.DataTable({
            ...
            stateSaveCallback: function (settings, data) {
                localStorage.setItem('INTERNSHIP_STATISTICS_INFO_' + page_param.paramInternshipReleaseId + settings.sInstance, JSON.stringify(data))
            },
            stateLoadCallback: function (settings) {
                return JSON.parse(localStorage.getItem('INTERNSHIP_STATISTICS_INFO_' + page_param.paramInternshipReleaseId + settings.sInstance))
            },
