        ...
        */
        ...
        var myTable = tableElement.DataTable({
            ...
            stateSaveCallback: function (settings, data) {
                localStorage.setItem('INTERNSHIP_STATISTICAL_UNSUBMITTED_' + page_param.paramInternshipReleaseId + settings.sInstance, JSON.stringify(data))
            },
            stateLoadCallback: function (settings) {
                return JSON.parse(localStorage.getItem('INTERNSHIP_STATISTICAL_UNSUBMITTED_' + page_param.paramInternshipReleaseId + settings.sInstance))
            },
