        ...
        */
        ...
        function getAjaxUrl() {
            return {
                ...
                delete_not_apply: web_path + '/web/internship/teacher-distribution/distribution/delete-not-apply',
        ...
        var myTable = tableElement.DataTable({
            ...
            stateSaveCallback: function (settings, data) {
                localStorage.setItem('INTERNSHIP_DISTRIBUTION_LOOK_' + page_param.paramInternshipReleaseId + settings.sInstance, JSON.stringify(data))
            },
            stateLoadCallback: function (settings) {
                return JSON.parse(localStorage.getItem('INTERNSHIP_DISTRIBUTION_LOOK_' + page_param.paramInternshipReleaseId + settings.sInstance))
            },
