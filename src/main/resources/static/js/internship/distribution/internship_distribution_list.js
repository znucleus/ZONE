        ...
        */
        ...
        var myTable = tableElement.DataTable({
            ...
            stateSaveCallback: function (settings, data) {
                localStorage.setItem('INTERNSHIP_DISTRIBUTION_CONDITION_' + page_param.paramInternshipReleaseId + settings.sInstance, JSON.stringify(data))
            },
            stateLoadCallback: function (settings) {
                return JSON.parse(localStorage.getItem('INTERNSHIP_DISTRIBUTION_CONDITION_' + page_param.paramInternshipReleaseId + settings.sInstance))
            },
