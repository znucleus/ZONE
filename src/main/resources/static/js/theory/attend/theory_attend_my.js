...
require(["jquery", "tools", "handlebars", "nav.active", "tablesaw", "jquery.address", "flatpickr-zh"],
    function ($, tools, Handlebars, navActive) {
        ...
        */
        var webStorageKey = {
            ATTEND_DATE: 'THEORY_ATTEND_MY_ATTEND_DATE_SEARCH' + page_param.paramTheoryReleaseId,
            OPERATE: 'THEORY_ATTEND_MY_OPERATE_SEARCH' + page_param.paramTheoryReleaseId
        };
