//# sourceURL=theory_attend_situation.js
require(["jquery", "nav.active", "responsive.bootstrap4", "jquery.address", "messenger", "flatpickr-zh"],
    function ($, navActive) {
        ...
        */
        var webStorageKey = {
            REAL_NAME: 'THEORY_ATTEND_SITUATION_REAL_NAME_SEARCH' + page_param.paramTheoryReleaseId,
            STUDENT_NUMBER: 'THEORY_ATTEND_SITUATION_STUDENT_NUMBER_SEARCH' + page_param.paramTheoryReleaseId,
            ATTEND_DATE: 'THEORY_ATTEND_SITUATION_ATTEND_DATE_SEARCH' + page_param.paramTheoryReleaseId,
            OPERATE: 'THEORY_ATTEND_SITUATION_OPERATE_SEARCH' + page_param.paramTheoryReleaseId
        };
        ...
        var myTable = tableElement.DataTable({
            ...
            stateSaveCallback: function (settings, data) {
                localStorage.setItem('THEORY_ATTEND_SITUATION_' + page_param.paramTheoryReleaseId + settings.sInstance, JSON.stringify(data))
            },
            stateLoadCallback: function (settings) {
                return JSON.parse(localStorage.getItem('THEORY_ATTEND_SITUATION_' + page_param.paramTheoryReleaseId + settings.sInstance))
            },
