...
require(["jquery", "lodash", "tools", "handlebars", "nav.active", "messenger", "jquery.address", "jquery.simple-pagination", "jquery-labelauty"],
    function ($, _, tools, Handlebars, navActive) {
         ...
         */
        var ajax_url = {
            data: web_path + '/web/theory/attend/theory/paging',
            list: '/web/theory/attend/list',
        ...
        */
        var webStorageKey = {
            TITLE: 'THEORY_ATTEND_TITLE_SEARCH',
            DATA_RANGE: 'THEORY_ATTEND_DATA_RANGE_SEARCH',
            PAGE_NUM: 'THEORY_ATTEND_PAGE_NUM'
        };
