//# sourceURL=theory_attend_users.js
require(["jquery", "lodash", "tools", "handlebars", "nav.active", "sweetalert2", "responsive.bootstrap4",
    ...
    function ($, _, tools, Handlebars, navActive, Swal) {
        ...
        var page_param = {
            ...
            paramTheoryAttendId: $('#paramTheoryAttendId').val(),
        ...
        */
        var param = {
            ...
            studentNumber: '',
            operate: '',
            theoryAttendId: page_param.paramTheoryAttendId
        };
        ...
        */
        var webStorageKey = {
            REAL_NAME: 'THEORY_ATTEND_USERS_REAL_NAME_SEARCH_' + page_param.paramTheoryAttendId,
            STUDENT_NUMBER: 'THEORY_ATTEND_USERS_STUDENT_NUMBER_SEARCH_' + page_param.paramTheoryAttendId,
            OPERATE: 'THEORY_ATTEND_USERS_OPERATE_SEARCH_' + page_param.paramTheoryAttendId
        };
        ...
        var myTable = tableElement.DataTable({
            ...
            stateSaveCallback: function (settings, data) {
                localStorage.setItem('THEORY_ATTEND_USERS_' + page_param.paramTheoryReleaseId + settings.sInstance, JSON.stringify(data))
            },
            stateLoadCallback: function (settings) {
                return JSON.parse(localStorage.getItem('THEORY_ATTEND_USERS_' + page_param.paramTheoryReleaseId + settings.sInstance))
            },
        ...
        */
        ...
        /*
         删除
         */
        function theory_del(attendUsersId, realName) {
            Swal.fire({
        ...
        function sendDelAjax(attendUsersId) {
            $.ajax({
                type: 'POST',
                url: getAjaxUrl().del,
                data: {attendUsersIds: attendUsersId, theoryReleaseId: page_param.paramTheoryReleaseId},
