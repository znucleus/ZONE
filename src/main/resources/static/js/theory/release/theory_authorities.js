//# sourceURL=theory_authorities.js
require(["jquery", "tools", "handlebars", "sweetalert2", "nav.active", "tablesaw", "messenger", "jquery.address"],
    function ($, tools, Handlebars, Swal, navActive) {
        ...
        function getAjaxUrl() {
            return {
                data: web_path + '/web/theory/release/authorities/data',
                add: web_path + '/web/theory/release/authorities/add',
                edit: web_path + '/web/theory/release/authorities/edit',
                del: web_path + '/web/theory/release/authorities/delete',
