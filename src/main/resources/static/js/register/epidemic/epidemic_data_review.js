        ...
        */
        ...
        var myTable = tableElement.DataTable({
            ...
            stateSaveCallback: function (settings, data) {
                localStorage.setItem('REGISTER_EPIDEMIC_DATA_' + page_param.paramEpidemicRegisterReleaseId + settings.sInstance, JSON.stringify(data))
            },
            stateLoadCallback: function (settings) {
                return JSON.parse(localStorage.getItem('REGISTER_EPIDEMIC_DATA_' + page_param.paramEpidemicRegisterReleaseId + settings.sInstance))
            },
