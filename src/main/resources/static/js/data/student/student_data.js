...
require(["jquery", "lodash_plugin", "tools", "handlebars", "nav.active", "sweetalert2", "responsive.bootstrap4",
    ...
    function getAjaxUrl() {
        return {
            data: web_path + '/web/data/student/paging',
            role_data: web_path + '/web/data/student/role/data',
            setting_role: web_path + '/web/data/student/role/save',
            update_enabled: web_path + '/web/data/student/update/enabled',
            update_locked: web_path + '/web/data/student/update/locked',
            del: web_path + '/web/data/student/delete',
            reset_password: web_path + '/web/data/student/update/password',
            page: '/web/menu/data/student'
        };
    }
    ...
    */
    var webStorageKey = {
        SCHOOL: 'DATA_STUDENT_SCHOOL_SEARCH',
        COLLEGE: 'DATA_STUDENT_COLLEGE_SEARCH',
        DEPARTMENT: 'DATA_STUDENT_DEPARTMENT_SEARCH',
        SCIENCE: 'DATA_STUDENT_SCIENCE_SEARCH',
        GRADE: 'DATA_STUDENT_GRADE_SEARCH',
        ORGANIZE: 'DATA_STUDENT_ORGANIZE_SEARCH',
        STUDENT_NUMBER: 'DATA_STUDENT_STUDENT_NUMBER_SEARCH',
        REAL_NAME: 'DATA_STUDENT_REAL_NAME_SEARCH',
        USERNAME: 'DATA_STUDENT_USERNAME_SEARCH',
        EMAIL: 'DATA_STUDENT_EMAIL_SEARCH',
        MOBILE: 'DATA_STUDENT_MOBILE_SEARCH',
        AUDITED: 'DATA_STUDENT_AUDITED_SEARCH'
    };
    ...
    function initParam() {
        ...
        param.science = $(getParamId().science).val();
        ...
        if (typeof (Storage) !== "undefined") {
            ...
            sessionStorage.setItem(webStorageKey.SCIENCE, param.science);
    ...
    */
    function initSearchContent() {
        ...
        if (typeof (Storage) !== "undefined") {
            ...
            science = sessionStorage.getItem(webStorageKey.SCIENCE);
    ...
    */
    function initSearchInput() {
        ...
        if (science !== null) {
            $(getParamId().science).val(science);
        }
    ...
    $(getParamId().science).keyup(function (event) {
        if (event.keyCode === 13) {
            initParam();
            myTable.ajax.reload();
        }
