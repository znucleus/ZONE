...
require(["jquery", "lodash_plugin", "tools", "handlebars", "nav.active", "sweetalert2", "responsive.bootstrap4",
    ...
    function getAjaxUrl() {
        return {
            data: web_path + '/web/data/staff/paging',
    ...
    */
    ...
    var myTable = tableElement.DataTable({
        ...
        stateSaveCallback: function (settings, data) {
            localStorage.setItem('DATA_STAFF_' + settings.sInstance, JSON.stringify(data))
        },
        stateLoadCallback: function (settings) {
            return JSON.parse(localStorage.getItem('DATA_STAFF_' + settings.sInstance))
        },
