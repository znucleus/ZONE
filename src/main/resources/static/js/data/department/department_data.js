        ...
        */
        ...
        var myTable = tableElement.DataTable({
            ...
            stateSaveCallback: function (settings, data) {
                localStorage.setItem('DATA_DEPARTMENT_' + settings.sInstance, JSON.stringify(data))
            },
            stateLoadCallback: function (settings) {
                return JSON.parse(localStorage.getItem('DATA_DEPARTMENT_' + settings.sInstance))
            },
