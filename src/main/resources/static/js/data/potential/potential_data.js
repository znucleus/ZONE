...
require(["jquery", "lodash_plugin", "tools", "handlebars", "nav.active", "sweetalert2", "responsive.bootstrap4",
    ...
    function getAjaxUrl() {
        return {
            ...
            update_locked: web_path + '/web/data/potential/update/locked',
            del: web_path + '/web/data/potential/delete',
            reset_password: web_path + '/web/data/potential/update/password',
            page: '/web/menu/data/potential'
        };
    }
    ...
    */
    var webStorageKey = {
        SCHOOL: 'DATA_POTENTIAL_SCHOOL_SEARCH',
        COLLEGE: 'DATA_POTENTIAL_COLLEGE_SEARCH',
        REAL_NAME: 'DATA_POTENTIAL_REAL_NAME_SEARCH',
        USERNAME: 'DATA_POTENTIAL_USERNAME_SEARCH',
        EMAIL: 'DATA_POTENTIAL_EMAIL_SEARCH',
        MOBILE: 'DATA_POTENTIAL_MOBILE_SEARCH',
        AUDITED: 'DATA_POTENTIAL_AUDITED_SEARCH'
    };
    ...
    var myTable = tableElement.DataTable({
        ...
        stateSaveCallback: function (settings, data) {
            localStorage.setItem('DATA_POTENTIAL_' + settings.sInstance, JSON.stringify(data))
        },
        stateLoadCallback: function (settings) {
            return JSON.parse(localStorage.getItem('DATA_POTENTIAL_' + settings.sInstance))
        },
        "processing": true, // 打开数据加载时的等待效果
        "serverSide": true,// 打开后台分页
        "aaSorting": [[18, 'desc']],// 排序
        "ajax": {
            "url": getAjaxUrl().data,
            "dataSrc": "data",
            "data": function (d) {
